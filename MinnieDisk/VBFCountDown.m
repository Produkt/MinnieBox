...
- (void) addMainCircle {
    ...
    self.mainCircle.strokeColor = [UIColor colorWithWhite:0.0 alpha:0.9].CGColor;
...
- (void) addNewDivision {
    ...
    CGPoint startP = CGPointMake(selfCenter.x + radius * cosf(currentAngle),
                                 selfCenter.y + radius * sinf(currentAngle));
    CGPoint endP = CGPointMake(selfCenter.x + (radius + divisionLength) * cosf(currentAngle),
                               selfCenter.y + (radius + divisionLength) * sinf(currentAngle));
    ...
    division.strokeColor = [UIColor blueColor].CGColor;
